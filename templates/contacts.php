  ...
  <section class="section contacts-section">
    <div class="container">
      <div class="inner-container contacts">
        ...
        <a class="contacts__phone" href="tel:<?php echo esc_html($company_phone_number) ?>"><svg width="40px" height="40px"><use href="<?php echo get_template_directory_uri()?>/src/images/sprite.svg#icon-phone"></use></svg><p><?php echo esc_html($company_phone_number) ?></p></a>
        <?php endif ?>
      </div>
      </div>
    </div>
